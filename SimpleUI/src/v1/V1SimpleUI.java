...
/**
 * 
 * This is the first version of the SimpleUI concept. Use the better v2 version
 * via the {@link SimpleUI} activity <br>
 * <br>
 * <br>
 * <br>
 * 
 ...
 * 
 * < activity android:name="SimpleUI" android:theme=
 ...
 */
@Deprecated
public class V1SimpleUI extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (transfairList != null) {
			V1SimpleUiController o = (V1SimpleUiController) transfairList
					.get(key);
			if (o != null) {
	...
	private static void showInContext(Activity target, V1SimpleUiController o,
	...
	private static LinearLayout generateViewFor(Activity target,
			V1SimpleUiController o, Object optionalMessage, UIConfig config) {
	...
	public static void showEditScreen(final Activity currentActivity,
			V1SimpleUiController objectToEdit, Object optionalMessage) {
	...
	public static void show(Context context,
			V1SimpleUiController itemToDisplay, Object optionalMessage,
			UIConfig config) {
		Intent intent = new Intent(context, V1SimpleUI.class);
	...
	private static String addTransfairObject(Context context,
			V1SimpleUiController itemToDisplay, Object message, UIConfig config) {
		if (transfairList == null)
