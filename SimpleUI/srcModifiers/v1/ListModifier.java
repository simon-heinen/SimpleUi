...
public abstract class ListModifier extends AbstractModifier {
	...
	public View getView(final Context context) {
		...
		listView.setPadding(V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING,
				V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING);
		listControls.setPadding(V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING,
				V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING);
		myListView.setPadding(V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING,
				V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING);
		if (getTheme() != null) {
