...
public class InfoText extends AbstractModifier {
	...
	public View getView(Context context) {
		...
		if (myName != null) {
			...
			e.setText(myText);
			l.addView(e);
			l.setPadding(V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING);
			...
			t.setPadding(V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING, V1SimpleUI.DEFAULT_PADDING);
